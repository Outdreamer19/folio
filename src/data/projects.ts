...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'I designed and built my portfolio from scratch as a frontend engineering showcase in its own right. The stack is React 19, TypeScript, Vite and Framer Motion — with a custom cursor system, fullscreen animated nav, particle text, glassmorphism cards and scroll-driven animations throughout. Every interaction was a deliberate decision.',
    challenge:
      'The challenge was building something that feels polished without being overcrowded. Every animation had to serve the content rather than distract from it, and the whole thing had to stay fast. Balancing visual ambition with performance and readability took several full redesign passes.',
    highlights: [
      'Custom cursor with mix-blend-mode difference — stays visible on any background colour',
      'Fullscreen navigation overlay with staggered link animations and z-index layering',
      'Particle text and Framer Motion scroll-driven entrance animations throughout',
      'Glassmorphism TravelingCard component with spring physics and 3D tilt',
      'Project detail pages with count-up stats, build timeline and live/GitHub links',
      'Deployed on Vercel with automatic CI/CD from GitHub on every push',
    ],
    techGroups: [
      { label: 'Frontend', items: ['React 19', 'TypeScript', 'Framer Motion', 'Tailwind CSS'] },
      { label: 'Build', items: ['Vite', 'ESLint'] },
      { label: 'Routing', items: ['React Router'] },
      { label: 'Deploy', items: ['Vercel', 'CI/CD'] },
    ],
    tech: ['React 19', 'TypeScript', 'Vite', 'Framer Motion', 'Tailwind CSS', 'React Router', 'Vercel'],
    year: '2025',
    status: 'live',
    liveUrl: 'https://shanebell.dev',
    githubUrl: 'https://github.com/Outdreamer19/folio',
    featured: true,
    color: 'rgb(6, 182, 212)',
    bgGradient: 'linear-gradient(135deg, rgb(6,182,212) 0%, rgb(34,211,238) 100%)',
    screenshots: {
      desktop: '/screenshots/shanebell-desktop.jpg',
      mobile: '/screenshots/shanebell-mobile.jpg',
    },
  },
  {
    id: 5,
