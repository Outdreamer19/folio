...
const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    description: 'A full-featured hospitality web application for a Caribbean smokehouse restaurant. Beyond a marketing site — includes a complete online reservation system, events and vacancies board, full admin dashboard, and newsletter marketing tools.',
